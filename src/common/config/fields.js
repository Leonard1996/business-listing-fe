export const items = [
    {
        ...
        label: "Owner Name",
        name: "ownerName",
        view: ["viewer", "member", "qualified", "hc", "company"],
        filter: [],
    },
    {
        type: "number",
    ...
    },
    {
        ...
        label: "No. of Staff",
        name: "noOfStaff",
        view: ["qualified", "hc", "company"],
        filter: ["qualified", "hc", "company"],
    },
    {
        type: "number",
    ...
    },
    {
        ...
        name: "relocatable",
        view: ["member", "qualified", "hc", "company"],
        filter: ["qualified", "hc", "company"],
    },
    {
        type: "select",
    ...
    },
    {
        ...
        name: "reference",
        view: ["viewer", "member", "qualified", "hc", "company"],
        filter: ["viewer", "member", "qualified", "hc", "company"],
    },
    {
        type: "select",
        label: "Industry",
    ...
    { type: "text", label: "Title", name: "title", view: ["viewer", "member", "qualified", "hc", "company"], filter: [] },
    {
        type: "currency",
        label: "Current Debts",
        name: "currentDebts",
